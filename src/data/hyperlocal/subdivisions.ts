...
export const subdivisions: HyperlocalSubdivision[] = [
  {
    ...
    answerSummary:
      'Eaglepointe is a Century Communities subdivision in Skye Canyon, Las Vegas NV 89166, with flexible floor plans, up to six bedrooms, and access to community parks and recreation. Confirm current builder pricing on live MLS.',
    features: [
    ...
    faqs: [
      {
        ...
        answer:
          'Eaglepointe pricing varies by lot, elevation, and selected upgrades. Contact Dr. Jan Duffy at (702) 500-1902 for current inventory and builder incentives.',
      },
      {
  ...
  },
  {
    ...
    answerSummary:
      'Marvella is a Century Communities neighborhood in Skye Canyon NV 89166 with customizable one- and two-story layouts and access to Skye Canyon parks and recreation. Confirm current pricing on live MLS.',
    features: [
    ...
    faqs: [
      {
        ...
        answer:
          'Marvella emphasizes customizable one- and two-story floor plans with premium finishes and energy-efficient construction. Confirm current pricing and sit within Skye Canyon’s recreation and park network.',
      },
      {
  ...
  },
  {
    ...
    bedrooms: 'Up to 6',
    description:
      'Skyecrest is Century Communities’ Skye Canyon enclave with expanded floor plans, high-end finishes, and luxury primary suites in zip code 89166. Confirm current builder pricing on live MLS.',
    answerSummary:
      'Skyecrest is the Century Communities subdivision in Skye Canyon NV 89166 with expanded floor plans and luxury primary suite options. Confirm current pricing on live MLS.',
    features: [
    ...
    faqs: [
      {
        ...
        answer:
          'Skyecrest pricing varies by lot and finish package. As Century Communities’ expanded offering in the community, Skyecrest features larger floor plans. Call (702) 500-1902 for current inventory.',
      },
      {
